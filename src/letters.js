...
var consonantLangs = [// "Tamil"
  ...
  // "Malayalam"
  [['ക', 'ഖ', 'ഗ', 'ഘ', 'ങ', 'ച', 'ഛ', 'ജ', 'ഝ', 'ഞ', 'ട', 'ഠ', 'ഡ', 'ഢ', 'ണ', 'ത', 'ഥ', 'ദ', 'ധ', 'ന', 'പ', 'ഫ', 'ബ', 'ഭ', 'മ', 'യ', 'ര', 'ല', 'വ','ഩ', 'ശ', 'ഷ', 'സ', 'ഹ', 'ള', 'ഴ', 'റ','റ്റ','ർ','ൾ','ൽ','ൻ','ൺ','ൿ'],
  ['k', 'kha', 'g', 'gha', 'nya', 'cha', 'cha', 'ja', 'jha', 'na', 'd', 'tha', 'd', 'd', 'na', 'tha', 'tha', 'd', 'dha', 'na', 'b', 'fa', 'b', 'bha', 'ga', 'a', 'r', 'la','la', 'va', 'sha', 'sha', 's', 'ha', 'la', 'zha', 'r','Ṇa','na','ra','la','Ḷa','ka']],
  // "Gujarati"
