...
['a', 'aa', 'e', 'e', 'u', 'oo', 'ri', 'ౠ', 'e', 'a', 'i', 'o', 'o', 'au', 'am', 'aah','']],
// "Kannada"
[['ಅ', 'ಆ', 'ಇ', 'ಈ', 'ಉ', 'ಊ', 'ಋ', 'ೠ', 'ಎ', 'ಏ', 'ಐ', 'ಒ', 'ಓ', 'ಔ', 'ಅಂ', 'ಅಃ', '—'],
['a', 'a', 'i', 'e', 'u', 'u', 'r', 'Yeo', 'a', 'a', 'i', 'o', 'o', 'ou', 'am', 'ah','']],
// "Bangla"
[['অ', 'আ', 'ই', 'ঈ', 'উ', 'ঊ', 'ঋ', 'ৠ', 'ঌ', 'ৡ', 'এ', 'ঐ', 'ও', 'ঔ'],
['a', 'a', 'e', 'e', 'u', 'u', 'ri', 'rī', 'li', 'lī', 'e', 'ai', 'o', 'au']],
// "Hindi"
[['अ', 'आ', 'इ', 'ई', 'उ', 'ऊ','ऋ', 'ए', 'ऐ', 'ओ', 'औ', 'अं', 'अः'],
['a', 'a', 'i', 'e', 'u', 'u', 'ri','a', 'aye', 'o', 'au', 'an', 'ah']],
// "Punjabi"
[['ਅ', 'ਆ', 'ਇ', 'ਈ', 'ਉ', 'ਊ', 'ਏ', 'ਐ', 'ਓ', 'ਔ'],
['a', 'a', 'i', 'e', 'u', 'u', 'a', 'ai', 'o', 'au']],
// "Malayalam"
[['അ', 'ആ', 'ഇ', 'ഈ', 'ഉ', 'ഊ', 'ഋ', 'ൠ', 'ഌ', 'ൡ', 'എ', 'ഏ', 'ഐ', 'ഒ', 'ഓ', 'ഔ', 'അം', 'അഃ'],
['a', 'a', 'i', 'e', 'u', 'u', 'r', 'ൠ', 'ഌ', 'ൡ', 'a', 'a', 'ai', 'o', 'o', 'au', 'am', 'ah']],
// "Gujarati"
[['અ', 'આ', 'ઇ', 'ઈ', 'ઉ', 'ઊ', 'ઋ', 'ૠ', 'ઌ', 'ૡ', 'એ', 'ઍ', 'ઐ', 'ઓ', 'ઑ', 'ઔ', 'અઁ', 'અં', 'અઃ'],
['a', 'aa', 'ī', 'e', 'u', 'u', 'ri','rī','li','lī', 'a', 'e', 'ai', 'o', 'awe', 'au', 'an', 'an', 'ah']],
// "Sinhala"
...
['k', 'kha', 'ga', 'ma', 'ga', 'c', 'chha', 'b', 'bha', 'gha', 'ra', 'ri', 'd', 'dh', 'ma', 's', 'ma', 'th', 'bha', 'na', 'du', 'pi', 'pe', 'bha', 'ga', 'ro', 'ra', 'la', 'ku', 'sha', 'sha', 'sa', 's', 'ma', 'ksha', 'saa']], 
//"Kannada"
[['ಕ', 'ಖ', 'ಗ', 'ಘ', 'ಙ', 'ಚ', 'ಛ', 'ಜ', 'ಝ', 'ಞ', 'ಟ', 'ಠ', 'ಡ', 'ಢ', 'ಣ', 'ತ', 'ಥ', 'ದ', 'ಧ', 'ನ', 'ಪ', 'ಫ', 'ಬ', 'ಭ', 'ಮ', 'ಯ', 'ರ', 'ಱ', 'ಲ', 'ವ', 'ಶ', 'ಷ', 'ಸ', 'ಹ', 'ಳ', 'ೞ'],
['k', 'kha', 'ga', 'gha', 'ny', 'c', 'cha', 'ja', 'jha', 'na', 's', 'tha', 'd', 'dha', 'na', 't', 'tha', 'da', 'dha', 'na', 's', 'f', 'b', 'bha', 'ga', 'ya', 'r', 'ra', 'la', 'ka', 'sha', 'sha', 's', 'ha', 'la', 'la']],
// "Bangla"
