...
[['ক', 'খ', 'গ', 'ঘ', 'ঙ', 'চ', 'ছ', '𑒕', 'জ', 'ঝ', '𑒗', 'ঞ', 'ট', '𑒙', 'ঠ', 'ড', 'ড়', 'ঢ', 'ঢ়', 'ণ', 'ত', 'থ', 'দ', 'ধ', 'ন', 'প', 'ফ', '𑒤', 'ব', 'ভ', 'ম', 'য', 'য়', 'র', 'ৰ', 'ল', '𑒪', 'ৱ', 'শ', 'ষ', 'স', 'হ'],['k', 'kha', 'ga', 'gha', 'na', 'ch', 'cha', '𑒕', 'ja', 'jha', '𑒗', 'na', 't', '𑒙', 'th', 'd', 'd', 'dh', 'dh', 'na', 'ta', 'th', 'da', 'dha', 'na', 'p', 'f', '𑒤', 'b', 'v', 'm', 'ya', 'ya', 'ra', 'ra', 'l', '𑒪', 'o', 'sh', 'sh', 's', 'h']], // fix
...
[['ક', 'ખ', 'ગ', 'ઘ', 'ઙ', 'ચ', 'છ', 'જ', 'ઝ', 'ઞ', 'ટ', 'ઠ', 'ડ', 'ઢ', 'ણ', 'ત', 'થ', 'દ', 'ધ', 'ન', 'પ', 'ફ', 'બ', 'ભ', 'મ', 'ય', 'ર', 'લ', 'ળ', 'વ', 'શ', 'ષ', 'સ', 'હ', 'ળ'],['kalpesh', 'kh', 'gajendra', 'gh', 'jain', 'chaudhari', 'chh', 'j', 'z', 'jain', 'ta', 'th', 'de', 'dh', 'bhai', 'bhai', 'th', 'the', 'dh', 'n', 'pa', 'fa', 'b', 'bhai', 'ma', 'ya', 'ra', 'bhai', 'dariya', 'varu', 'sh', 'sh', 's', 'hira', 'dariya']], // fix
